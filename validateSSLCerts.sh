...
## TODO                                                                          #
##==============================================================================##
# 1. Update README with instructions and include Synology + Gitlab docker gist
# 2. Research if Synology NAS autorenews invalidated certs; if not, research how to force renew after X days before
...
#===============================================================================##
## VALIDATE CERTS -- ATTEMTPS TO VALIDATE LETS ENCRYPT CERTIFICATIONS            #
##==============================================================================##
...
function _check_paths
{
	if [ ! -d "$gLetsEncryptPath" ];
		then
			_abort_session "Unable to locate the Let's Encrypt certifications path."
	fi
