...
- [Automation Through Crontab](#automation-through-crontab)
	- [Option 1: Implementing a Preconfigured Cron Job](#option-1-implementing-a-preconfigured-cron-job)
	- [Option 2: Creating a Custom Cron Job](#option-2-creating-a-custom-cron-job)
